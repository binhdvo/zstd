...
println "test: out of bounds clevel message"
zstd tmpro -c -20 2>&1 | grep "Warning : compression level higher than max, reduced to"
zstd tmpro -c -25 --ultra 2>&1 | grep "Warning : compression level higher than max for --ultra"
rm -f tmpro tmpro.zst
